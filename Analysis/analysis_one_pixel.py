...
from help_analysis_read import read_HySICS, read_all_LRT, read_solar
from help_analysis import calc_HySICS_reflectance, disagreement_all_LRT
...
LRT_IC_path = '../../../CU Boulder/LASP/LASP py/ICfiles/Outputs/ghm/'#solid-column/'#rough-aggregate/'
